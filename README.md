...
_This application is a basic online journal that allows a user to enter journal entries and view teasers of each entry._
...
* _$ cd desktop_
* _$ git clone https://github.com/michelle-morin/journal_
* _$ cd journal_

_Then, confirm that you have navigated to the journal project directory by entering "pwd" in Terminal._
